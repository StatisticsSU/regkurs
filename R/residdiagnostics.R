...
#' res.diagnostics(lmfit,outnorm = T)#6 plots together
#' res.diagnostics(lmfit,regressors=T)#show only the relationship between each regressor and the residuals
...
>>>>>>> 54652c212aaea2b33b916a2b5a16cf8aef701200
